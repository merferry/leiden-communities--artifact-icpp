#!/usr/bin/env bash
help() {
  echo "Run performance tests on large real-world graphs"
...
# Prepare
echo "Running performance tests on large real-world graphs ..."
mkdir -p "$LOGS"
ulimit -s unlimited
printf "" > "$OUT"
...
echo "Performance tests on large real-world graphs done"
echo ""
